...
<section class:active>
	...
	<div on:mouseleave={() => {
		...
		<a href="{$page.data.locale === 'fr' ? '' : `/${$page.data.locale}`}/projets?director={director.fields.tagIdentifier}" class:active={active && active.fields.identifier === film?.fields.identifier} on:mouseenter={() => {
			active = film
